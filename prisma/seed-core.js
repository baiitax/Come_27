...
const ARTICLES = [
  ...
  ['campaign-council-grassroots-volunteer-programme', 'Campaign Council opens grassroots volunteer recruitment across all 44 LGAs', 'press-release', 'Kano State', 'The Campaign Council of Comarade Aminu Abdussalam Gwarzo has opened recruitment for a grassroots volunteer programme across all 44 Local Government Areas of Kano State. The programme covers canvassing, event logistics, social media, photography and translation (Hausa–English).\n\nVolunteers register through the campaign website and are assigned to LGA coordination desks. The Council emphasised that all volunteers operate under the campaign’s code of conduct, which prohibits misinformation, impersonation and personal attacks.\n\nRegistration is open to all citizens of Kano State of voting age. No fee is charged at any stage of volunteer registration or deployment.', 'campaign, volunteers, grassroots', 'published', 4, 'Gwarzo 2027 Campaign Council'],
  ['campaign-council-44-lga-listening-tour', 'Campaign Council announces 44-LGA listening tour for the third quarter', 'press-release', 'Kano State', 'The Campaign Council has announced a 44-LGA listening tour that will take the campaign’s 12-pillar agenda to every Local Government Area of Kano State. The tour begins with the metropolitan LGAs and proceeds through the senatorial districts over the coming weeks.\n\nThe tour is structured as structured listening: residents are heard first, and the campaign’s responses are documented and published with clear attribution. No promise will be made on the tour that is not part of the published agenda.\n\nDates and venues for each LGA stop will be published on the campaign website and announced through the campaign’s official channels.', 'campaign, lga, tour', 'published', 12, 'Gwarzo 2027 Campaign Council'],
  ['campaign-council-transition-documentation-brief', 'Media briefing: the 2026 political transition, documented and attributed', 'press-release', 'Kano Municipal', 'The Campaign Council has issued a media briefing explaining how the 2026 political transition involving Comarade Gwarzo is presented on the campaign website: every event is documented with explicit attribution, and allegations are never presented as established facts.\n\nThe Council said each transition event carries an evidence status — verified, official-record, reported, campaign-claim or under-review — and that the website states plainly where data is insufficient.\n\nThe Council invited journalists to verify any item through the campaign’s facts and transparency center, where sources and evidence trails are published.', 'campaign, transparency, media', 'published', 18, 'Gwarzo 2027 Campaign Council'],
  ['campaign-council-fact-checker-registration', 'Campaign Council invites Kano’s fact-checkers and researchers to a standing verification panel', 'press-release', 'Kano State', 'The Campaign Council has invited independent fact-checkers, journalists, academics and data researchers across Kano State to join a standing verification panel that will review public claims about the campaign and the 2026 political transition.\n\nPanel members will work through the campaign’s facts and transparency center, which publishes every claim, its evidence trail, sources and verdicts. The Council stressed that panel membership carries no obligation to produce favourable findings.\n\nApplications and nominations are open through the campaign’s engagement page.', 'campaign, facts, verification', 'published', 25, 'Gwarzo 2027 Campaign Council'],
  ['campaign-council-12-pillar-publication', 'Campaign Council publishes the complete 12-pillar development agenda', 'press-release', 'Kano Municipal', 'The Campaign Council of Comarade Aminu Abdussalam Gwarzo has published the complete 12-pillar development agenda for Kano State, covering education, healthcare, water, roads, agriculture, employment, security, commerce, women, the digital economy, human capital and infrastructure.\n\nEach pillar is published with its problem statement, current context, approach, objectives and proposed delivery structure — and is clearly marked as proposed policy, distinct from the candidate’s established record.\n\nThe Council said the agenda will be the reference document for every campaign promise, and that any commitment made on the ground must trace back to a published pillar.', 'campaign, policy, agenda', 'published', 40, 'Gwarzo 2027 Campaign Council'],
...
const CLAIMS = [
  ['Comarade Gwarzo served as Deputy Governor of Kano State (2023–2026)', 'Public record — state government service documentation', 'public-service', 'verified', 'Verified against Kano State Government service records and the state government’s public directory of officials.'],
...
async function seedCore(prisma) {
  ...
  const settings = [
    ...
    ['contact.facebook', ''],
    ['contact.instagram', ''],
    ['site.title', 'Comarade Aminu Abdussalam Gwarzo | 2027 Kano Governorship'],
  ...
  await prisma.candidate.create({
    data: {
      displayName: 'Comarade Aminu Abdussalam Gwarzo',
      fullName: 'Comarade Aminu Abdussalam Gwarzo',
  ...
  // articles
  for (const [slug, title, category, location, body, tags, status, daysAgo, author] of ARTICLES) {
    await prisma.article.create({
      data: {
        slug, title, category, location, body, tagsJson: JSON.stringify(tags.split(', ')),
        authorName: author || (category === 'press-release' ? 'Gwarzo 2027 Campaign Council' : 'Gwarzo 2027 Desk'),
        status, isDemo: false,
